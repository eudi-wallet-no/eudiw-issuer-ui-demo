...
import no.idporten.eudiw.issuer.ui.demo.integration.issuerserver.IssuerServerService;
import no.idporten.eudiw.issuer.ui.demo.integration.issuerserver.config.CredentialConfiguration;
import no.idporten.eudiw.issuer.ui.demo.integration.issuerserver.config.IssuerServerProperties;
import no.idporten.eudiw.issuer.ui.demo.integration.issuerserver.domain.IssuanceResponse;
...
public class StartIssuanceController {
    ...
    @ModelAttribute("allowBevisTyper")
    public boolean bevisTyperEnabled() {
        return bevisgeneratorProperties.getFeatureSwitches().isAllowCreateBevistyper();
    }
